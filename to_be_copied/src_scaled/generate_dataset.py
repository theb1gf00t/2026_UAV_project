...
─────────────────────
  ...
  between neighbouring sectors and self-heals after HEALING_PERIOD=14 days
...
HEALING_PERIOD = 7     # natural self-healing without UAV treatment.
                       # UAVs treat in TREATMENT_DAYS=3 days (uav_env.py),
                       # so active monitoring heals ~2.3× faster.
ALPHA          = 0.04  # base contact spread weight  (tuned for ~25 infected/day)
BETA           = 0.10  # wind-driven spread weight
